...
methodCode11: (chalk) =>
`NO SE PERMITE NÚMEROS QUE NO SEAN ${chalk.bold.greenBright('1')} O ${chalk.bold.greenBright('2')}, TAMPOCO LETRAS O SÍMBOLOS ESPECIALES.\n${chalk.bold.yellowBright('CONSEJO: COPIE EL NÚMERO DE LA OPCIÓN Y PÉGUELO EN LA CONSOLA.')}`,
...
mAdvertencia: '> ⚠️ *ПРЕДУПРИЖДЕНИЕ 𓃠*\n\n',
mInfo: '> 📢 *INFORMACIÓN 𓃠*\n\n',
mExito: '> ✅ *ÉXITO 𓃠*\n\n',
mError: '> ❌ *ERROR 𓃠*\n\n',
...
//_antilink.js
mWhatsApp: '*¡Обнаружена ссылка нарушения!*\n*Я тебя удалю*',
...
smsAutodetec7: (m, usuario) => `@${m.messageStubParameters[0].split`@`[0]} ВАС НАЗНАЧИЛИ АДМИНОМ\n\n😼🫵: ${usuario}`,
smsAutodetec8: (m, usuario) => `@${m.messageStubParameters[0].split`@`[0]} ВЫ БОЛЬШЕ НЕ АДМИН\n\n😼🫵: ${usuario}`,
...
//grupos
smsAdd:
'Hola! me presento, soy GataBot-MD 🐈, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!',
